...
type EmbedEditorFieldDropdownFormProps = {
  value: DropdownFieldMeta | undefined;
  onValueChange: (value: DropdownFieldMeta) => void;
};

export const EmbedEditorFieldDropdownForm = ({
  value = {
    type: 'dropdown',
  },
  onValueChange,
}: EmbedEditorFieldDropdownFormProps) => {
  const { t } = useLingui();
                  ...
                  <FormControl>
                    <div ref={ref}>
                      <Select
                        ...
                        value={field.value ?? '-1'}
                        onValueChange={(value) =>
                          field.onChange(value === '-1' ? undefined : value)
                        }
                      >
