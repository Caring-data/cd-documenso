...
export default function EmbedFieldsPageRenderer() {
  ...
  const localPageFields = useMemo(
    ...
    [editorFields.localFields, pageContext.pageNumber, currentEnvelopeItem?.id],
  );
  ...
  const unsafeRenderFieldOnLayer = (field: TLocalField) => {
    ...
    const isFieldEditable = recipient !== undefined;
...
const FieldActionButtons = ({
  ...
  const { editorFields, envelope } = useCurrentEmbedTemplateEditor();
